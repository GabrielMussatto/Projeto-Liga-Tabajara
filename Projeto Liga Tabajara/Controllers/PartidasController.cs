...
namespace Projeto_Liga_Tabajara.Controllers
{
    public class PartidasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Data,Rodada,Estadio,TimeMandanteId,TimeVisitanteId,GolsMandante,GolsVisitante,Resultado")] Partida partida)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Data,Rodada,Estadio,TimeMandanteId,TimeVisitanteId,GolsMandante,GolsVisitante,Resultado")] Partida partida)
        {
            if (ModelState.IsValid)
            {
